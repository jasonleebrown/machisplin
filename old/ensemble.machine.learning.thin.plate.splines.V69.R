...
##################################################################################################
	...
	## Export packages
	sfLibrary('terra', warn.conflicts=FALSE, character.only=TRUE)
	sfLibrary('MACHISPLIN', warn.conflicts=FALSE, character.only=TRUE)
	sfLibrary('sp', warn.conflicts=FALSE, character.only=TRUE)
